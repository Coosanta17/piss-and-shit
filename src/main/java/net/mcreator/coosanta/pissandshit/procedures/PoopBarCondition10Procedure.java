...
public class PoopBarCondition10Procedure {

	public static boolean execute(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PissAndShitMod.LOGGER.warn("Failed to load dependency entity for procedure PoopBarCondition10!");
			return false;
		}
		...
		}.getScore("poop_amount", entity) >= 10) {
			return true;
		}
		return false;
	}
