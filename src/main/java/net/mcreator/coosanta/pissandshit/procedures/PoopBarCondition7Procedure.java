...
public class PoopBarCondition7Procedure {

	public static boolean execute(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PissAndShitMod.LOGGER.warn("Failed to load dependency entity for procedure PoopBarCondition7!");
			return false;
		}
