...
public class PissAndShitModMenus {
	...
	public static void load() {
		POOP_BAR = Registry.register(BuiltInRegistries.MENU, new ResourceLocation(PissAndShitMod.MODID, "poop_bar"), new ExtendedScreenHandlerType<>(PoopBar0Menu::new));
		PoopBar0Menu.screenInit();
	}
}
